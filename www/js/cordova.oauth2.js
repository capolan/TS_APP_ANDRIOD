...
(function($){            
    $.oauth2 = function (options, successCallback, errorCallback) {
        ...
        var loginWindow = window.open(decodeURIComponent(login_url), '_blank', 'location=yes,clearsessioncache=yes');
...
function googleSiginIn() {
    $.oauth2({
        ...
        client_id: '629413010047-mirv8igteh3qrh1vfigu8lalr55hgo21.apps.googleusercontent.com',
        redirect_uri: 'http://ts0.sensoronline.net/obj/ti/tokensignin.php',
